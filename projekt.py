...
vertices_list = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 2000, 3000]

for vertices_number in vertices_list:
    ...
    x = pd.read_csv(f"{vertices_number}_wierzcholkow.csv")
    x = x.drop('Unnamed: 0', axis=1)

    graph = pd.DataFrame.to_numpy(x)
    ...
    if my_rank == 0:
        ...
        print(f"{vertices_number} wierzchlkow: {end - start}")
